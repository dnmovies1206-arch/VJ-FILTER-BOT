...
# Ask Doubt on telegram  @MRDRAGONK
...
# Bot information
SESSION = environ.get('SESSION', 'dn')
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/vens42.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8141314253 6390511215 7734821136').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002542788675').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002988640125') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL',1002988640125 '')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/kannadanewmoviea')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+GB4qVgc43bE2MWY9')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+_MHouSzAbJVlM2Rl') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/dragonkannadavmovie')
...
SHORTLINK_URL = environ.get('SHORTLINK_URL',https://shortxlinks.in '')
SHORTLINK_API = environ.get('SHORTLINK_API',b460d2482ff023d8ce65e20415c7994ea8d68ae0 '')
